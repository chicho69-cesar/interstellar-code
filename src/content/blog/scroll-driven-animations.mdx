...
description: Las scroll driven animations o animaciones a través del scroll son especiales porque nos permiten crear animaciones que se sincronizan con el desplazamiento de la página, creando una experiencia más fluida y natural para el usuario, además de que nos permite hacer cosas que antes no eran posibles sin utilizar JavaScript.
date: 2025-06-14
tags: [CSS]
