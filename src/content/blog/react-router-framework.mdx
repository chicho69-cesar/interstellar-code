...
description: React Router es la evolución natural de dos de las herramientas más utilizadas en el ecosistema de React, combinando el uso y la simplicidad que ofrece React Router como librería combinándolo con el poder de un framework de Server Side Rendering como lo es Remix, naciendo asi una alternativa muy poderosa a NextJS.
date: 2025-06-03
tags: [React Router, React, Remix, JavaScript, TypeScript]
